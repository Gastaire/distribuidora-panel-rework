...
// --- Componentes de Modales y Layout ---
  ...
  const PasswordConfirmModal = ({ title, message, onConfirm, onClose, loading }) => {
        ...
        // --- INICIO DE LA MODIFICACIÓN: Componente DataIntegrityView completamente rediseñado ---
